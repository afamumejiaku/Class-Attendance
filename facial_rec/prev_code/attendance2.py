...
class Face_rec:
    ...
    def face_rec(self):
        ...
        afam_image = face_recognition.load_image_file("photos/afam.jpg")
        afam_face_encoding = face_recognition.face_encodings(afam_image)[0]

        jake_image = face_recognition.load_image_file("photos/jake.jpg")
        jake_face_encoding = face_recognition.face_encodings(jake_image)[0]

        sunny_image = face_recognition.load_image_file("photos/sunny.jpg")
        sunny_face_encoding = face_recognition.face_encodings(sunny_image)[0]

        pham_image = face_recognition.load_image_file("photos/pham.jpg")
        pham_face_encoding = face_recognition.face_encodings(pham_image)[0]

        bipana_image = face_recognition.load_image_file("photos/bipana.jpg")
        bipana_face_encoding = face_recognition.face_encodings(bipana_image)[0]

        cameron_image = face_recognition.load_image_file("photos/cameron.jpg")
        cameron_face_encoding = face_recognition.face_encodings(cameron_image)[0]

        jaturong_image = face_recognition.load_image_file("photos/jaturong.jpg")
        jaturong_face_encoding = face_recognition.face_encodings(jaturong_image)[0]

        himel_image = face_recognition.load_image_file("photos/himel.jpg")
        himel_face_encoding = face_recognition.face_encodings(himel_image)[0]

        linh_image = face_recognition.load_image_file("photos/linh.jpg")
