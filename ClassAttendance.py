...
class Face_rec:
    ...
    def __init__(self):
        ...
        self.title_label = Label(self.title_frame, text='Class Attendance Recorder', justify='center',
                                 font=("Helvetica", 28), bg='#d9e6f2')
        ...
        self.time_label = Label(self.main_frame, text='Enter run time in minutes:', bd=0, justify='left',
                                font=("Helvetica", 14), bg="#ecf2f9")

        self.time_label.place(relx=.05, rely=.6, anchor='w')

        self.time_entry = Entry(self.main_frame, bd=2, width=8, justify='center', font=("Helvetica", 14),
                                relief='groove', highlightcolor="black")

        self.time_entry.place(relx=.5, rely=.6, anchor='w')

        self.course_label = Label(self.main_frame, text='Enter name of course:', bd=0, justify='left',
                                  font=("Helvetica", 14), bg="#ecf2f9")

        self.course_label.place(relx=.05, rely=.275, anchor='w')

        self.course_entry = Entry(self.main_frame, bd=2, width=16, justify='center', font=("Helvetica", 14),
                                  relief='groove', highlightcolor="black")
